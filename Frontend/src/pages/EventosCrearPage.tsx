...
export default function EventCreator() {
    ...
    return (
        <div className="container mx-auto p-6">
            ...
            <form onSubmit={handleSubmitEvent} className="mb-8">
                <div className="mb-4">
                ...
                <button type="submit" className="px-4 py-2 bg-[#00D67D] text-white rounded-md hover:bg-[#00B468] focus:outline-none focus:ring-2 focus:ring-[#00D67D] focus:ring-opacity-50">
                    Crear Evento
                </button>
            </form>
