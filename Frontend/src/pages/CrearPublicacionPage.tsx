...
export default function Component() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setSubmitMessage(
        `Publicación creada con éxito. Titulo: ${newPublicacion.titulo}`
      );
      setTitle("");
      setImageUrl("");
      setDescription("");
      ...
      setSubmitMessage(
        "Error al crear la publicación. Por favor, intente de nuevo."
      );
            ...
            <div className="space-y-2">
              ...
              >
                ...
                {tipoPrecios.map((tipoPrecio) => (
                  <option
                    key={tipoPrecio.tipoDePrecioId}
                    value={tipoPrecio.tipoDePrecioId}
                  >
